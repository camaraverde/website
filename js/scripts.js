...
// MagnificPopup  ----------------------------------------	
  ...
  var basicPopupGalleryOptions = {
	...
	$('#events.popup-gallery').magnificPopup(basicPopupGalleryOptions);

  $('#aerial-films.popup-gallery').magnificPopup(basicPopupGalleryOptions);
